...
namespace Sanatana.MongoDb.Repository
{
    ...
    {
        Task<long> CountDocuments(Expression<Func<T, bool>> filterConditions = null, CancellationToken token = default);
        ...
        Task<List<T>> FindAll(Expression<Func<T, bool>> filterConditions = null, CancellationToken token = default);
        ...
        /// <summary>
        /// Insert entity. Catch and return true in case of unique index exception.
        /// </summary>
        /// <param name="entity"></param>
        /// <param name="token"></param>
        /// <returns></returns>
        Task<bool> InsertOneHandleDuplicate(T entity, CancellationToken token = default);
